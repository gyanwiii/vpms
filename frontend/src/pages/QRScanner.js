...
export default function QRScanner() {
    ...
    const handleCheckin = async () => {
        await fetch(`https://visitor-pass-management-9jme.onrender.com/api/passes/${passData._id}/checkin`, {
            method: 'PUT',
            headers: { Authorization: `Bearer ${token}` }
        });
    ...
    const handleCheckout = async () => {
        await fetch(`https://visitor-pass-management-9jme.onrender.com/api/passes/${passData._id}/checkout`, {
            method: 'PUT',
            headers: { Authorization: `Bearer ${token}` }
        });
