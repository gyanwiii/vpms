...
export default function Reports() {
    ...
    const fetchSummary = async () => {
        const res = await fetch('https://visitor-pass-management-9jme.onrender.com/api/reports/summary', {
    ...
    const fetchVisitors = async () => {
        const res = await fetch('https://visitor-pass-management-9jme.onrender.com/api/reports/visitors', {
            headers: { Authorization: `Bearer ${token}` }
        });
        const data = await res.json();
        setVisitors(data);
    ...
    const fetchPasses = async () => {
        const res = await fetch('https://visitor-pass-management-9jme.onrender.com/api/reports/passes', {
            headers: { Authorization: `Bearer ${token}` }
        });
        const data = await res.json();
        setPasses(data);
    ...
    const fetchAppointments = async () => {
        const res = await fetch('https://visitor-pass-management-9jme.onrender.com/api/reports/appointments', {
            headers: { Authorization: `Bearer ${token}` }
        });
        const data = await res.json();
