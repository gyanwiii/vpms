...
export default function Appointment() {
    ...
    const fetchAppointments = async () => {
        try {
            const res = await fetch('https://visitor-pass-management-9jme.onrender.com/api/appointments', {
    ...
    const handleApprove = async (id) => {
        await fetch(`https://visitor-pass-management-9jme.onrender.com/api/appointments/${id}/approve`, {
            method: 'PUT',
            headers: { Authorization: `Bearer ${token}` }
        });
        fetchAppointments();
    ...
    const handleReject = async (id) => {
        await fetch(`https://visitor-pass-management-9jme.onrender.com/api/appointments/${id}/reject`, {
            method: 'PUT',
            headers: { Authorization: `Bearer ${token}` }
        });
        fetchAppointments();
